...
const mockCustomers = [
  {
    ...
    "alfSummary": "4일째 배송 상태 변경이 없는 상황에 강한 불만 호소. 주문한 상품이 아직 미수령 상태. 주문번호(GN-20260518-441) 확인 완료. 배송사에 직접 확인이 필요하며 매니저 처리 필요.",
    "openingText": "안녕하세요 황혜란 님, 불편을 드려서 정말 죄송합니다. 지금 바로 배송사에 직접 확인하겠습니다.",
    "openingTexts": [
      "황혜란 님, 주문이 아직 도착하지 않아서 많이 불편하셨겠습니다. 지금 바로 배송사에 직접 확인해서 배송 일정 안내드리겠습니다.",
      "GN-20260518-441 확인했습니다. 4일째 상태가 바뀌지 않아서 정말 죄송합니다. 배송사에 직접 확인하고 빠른 시간 내에 처리해드리겠습니다.",
      "황혜란 님, 오래 기다려 주셔서 감사합니다. 담당자가 직접 배송사에 확인 후 빠른 시일로 안내해드리겠습니다."
    ],
    "_persona": {
      "age": 33,
      "sex": "여자",
  ...
  },
  {
    ...
    "alfSummary": "구매 후 3개월된 공기청정기 불량 주장하며 반품 요청. 고객이 '불량품 보내놓고 어떻게'라며 강하게 항의. 2개월 사용 이력 있음. 명백한 불량이면 왕복 배송비 없이 처리 가능하므로 불량 여부 확인 후 반품 처리 방법 안내 필요.",
    "openingText": "안녕하세요 김다희 님, 불량품 관련해서 불편하셨다면 정말 죄송합니다. 바로 확인 후 최대한 편하게 반품 처리해드리겠습니다.",
    "openingTexts": [
      "김다희 님, 불량품 관련해서 불편하셨다면 명백한 불량 여부 먼저 확인할게요. 해당 경우 왕복 배송비 없이 처리해드리겠습니다. 지금 바로 확인해드리겠습니다.",
      "불량품 보내놓고 어떻게 그냥 넘어가냐고 하셨는데 고객님 말씀이 맞습니다. 불량 여부 확인 후 배송비 없이 반품 처리해드리겠습니다.",
      "김다희 님, 많이 기다려 주셔서 감사합니다. 불량 여부 확인 후 왕복 배송비 없이 전액 처리해드리겠습니다. 지금 바로 확인해드릴게요."
    ],
    "_persona": {
      "age": 46,
      "sex": "여자",
  ...
  },
  {
    ...
    "assigneeName": "서연",
    "emotion": "neutral",
    "alfEscalationReason": "배송 전 배송지 변경 요청. 챗봇에서 직접 설정 안내가 없었고 매니저 직접 처리 필요.",
